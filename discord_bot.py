...
token = "ODY5NDE4MDA5NjQ1Njk1MDE2.YP96ng.1wDYekIXPRl6NAcqDgFq2N9t8QI"
...
async def on_message(message):
    ...
    if message.content == "!dq 로블은":
        await message.channel.send("얜 대체 뭐야")
    ...
    if message.content == "!dq 나의 팬티색은?":
        ...
        if ran == 8:
            d = "빨강색을 입은걸 보니 열렬한 공산당원인가 보군ㅎㅎㅎㅎㅎ 중국의 위구르와 티베트가 돌립되갈 비네.https://www.youtube.com/watch?v=efDu-KVBz6w"
        if ran == 9:
            d = "빨강"
